...
---
本 skill 来自 **Matt Pocock** 的开源 skill [`grill-me`](https://github.com/mattpocock/skills/tree/main/skills/productivity/grill-me)（MIT 许可），其是一个领域无关的"拷问"框架——一次一问、沿决策树下钻、每问附推荐答案，直到每个分支都被解决。
